  ...
  void _login() {
    ...
    if (Id.isEmpty || password.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Please fill all the blanks')),
      );
      return;
    }
    if (Id == userid && password == adminpassword) {
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => AppVisitRequestPage(visitors: userdata!)),
    ...
    children: [
      ...
      Row(
        children: [
          ...
          Expanded(
            child: Container(color: Color(0xffffffff)), // Right side color
          ),
        ],
      ),
                        ...
                        child: Ink(
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                              colors:[const Color(0xff244c41), Color(0xff244c41)],
...
// ),
      ...
      floatingActionButton: Container(
        child: Padding(
          ...
          child: Text('© Design & Development by @ TECHPROMIND',style: TextStyle(color: Colors.white),),
        ), 
      ),
    );
  }
